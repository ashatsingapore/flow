...
public class ProcessStepResourceTest {
    ...
    public void initTest() {
        ...
        processStep.setCreatedBy(DEFAULT_CREATED_BY);
    ...
    public void createProcessStep() throws Exception {
        ...
        assertThat(testProcessStep.getCreatedBy()).isEqualTo(DEFAULT_CREATED_BY);
    ...
    public void updateProcessStep() throws Exception {
        ...
        processStep.setCreatedBy(UPDATED_CREATED_BY);
        ...
        assertThat(testProcessStep.getCreatedBy()).isEqualTo(UPDATED_CREATED_BY);
